...
{
    public static class LocalAuthenticationMiddleware
    {
        public static void UseLocalAuthentication(this IAppBuilder app)
        {
            ...
            // ToDo: Need to check if we can move this to external auth middleware
